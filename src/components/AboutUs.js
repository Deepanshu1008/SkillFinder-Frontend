      ...
      >
        ...
        <Flex justifyContent={'flex-end'} gap={3}>
          <IconButton
            ...
            onClick={() =>
              window.open(
                'https://github.com/Deepanshu1008',
                '_blank'
              )
            }
          />
          ...
          <Center py={6}>
            ...
            >
              ...
              <Flex justify={'center'} mt={-12}>
                <Avatar
                  size={'xl'}
                  src={'https://avatars.githubusercontent.com/u/97304706?v=4'}
                  alt={'Author'}
                  css={{
              ...
              <Box p={6}>
                ...
                <Stack direction={'row'} justify={'center'}>
                  <Center p={8}>
                    <a
                      href="https://www.linkedin.com/in/deepak1101/"
                      target="_blank"
                      rel="noreferrer"
                    >
                      <IconButton
                  ...
                  <Center p={8}>
                    <a href="https://github.com/foxcode11">
                      <IconButton
                        w={'full'}
                        mt={8}
                        rounded={'md'}
          ...
          <Center py={6}>
            ...
            >
              ...
              <Flex justify={'center'} mt={-12}>
                <Avatar
                  size={'xl'}
                  src={'https://avatars.githubusercontent.com/u/89475845?s=400&u=d24d6c6c74c1e6915fb169618f3a2db04886cf48&v=4'}
                  alt={'Author'}
                  css={{
                    border: '2px solid white',
                  }}
              ...
              <Box p={6}>
                ...
                <Stack direction={'row'} justify={'center'}>
                  <Center p={8}>
                    <a
                      href="https://www.linkedin.com/in/deepanshudp10/"
                      target="_blank"
                      rel="noreferrer"
                    >
                      <IconButton
          ...
          <Center py={6}>
            ...
            >
              ...
              <Flex justify={'center'} mt={-12}>
                <Avatar
                  size={'xl'}
                  src={'https://avatars.githubusercontent.com/u/104853696?v=4'}
                  alt={'Author'}
                  css={{
                    border: '2px solid white',
                  }}
              ...
              <Box p={6}>
                <Stack spacing={0} align={'center'} mb={5}>
                  ...
                  <Text color={'gray.500'}>UI/UX Developer</Text>
                </Stack>
                <Stack direction={'row'} justify={'center'}>
                  <Center p={8}>
                    <a
                      href="https://www.linkedin.com/in/sdeepti2906/"
                      target="_blank"
                      rel="noreferrer"
                    >
                      <IconButton
                  ...
                  <Center p={8}>
                    <a href="https://github.com/deepti-29">
                      <IconButton
                        w={'full'}
                        mt={8}
                        rounded={'md'}
